...
#PRIMERA OPERACION DEL CRUD: COPY 
    ...
    def InsertarValor(self, nombre, apellido, nombreUsuario, pais, provincia, email, contraseña):
...
#SEGUNDA OPERACION DEL CRUD : READ O LEER
    ...
    def BuscarObjeto(self, nombre, apellido, nombreUsuario, pais, provincia, email, contraseña):
